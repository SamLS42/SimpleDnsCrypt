...
public class DomainBlacklistViewModel : Screen
{
	...
	public DomainBlacklistViewModel(IWindowManager windowManager, IEventAggregator events)
	{
		...
		if (!string.IsNullOrEmpty(Properties.Settings.Default.DomainWhitelistRules))
		{
			...
			Task.Run(ReadWhitelistRulesFromFile);
		}
		else
		{
			//set default
		...
		if (!string.IsNullOrEmpty(Properties.Settings.Default.DomainBlacklistRules))
		{
			...
			Task.Run(ReadBlacklistRulesFromFile);
		}
		else
		{
			//set default
	...
	public void ChangeBlacklistFilePath()
	{
		try
		{
			FolderBrowserDialog blacklistFolderDialog = new()
			{
			...
			DialogResult result = blacklistFolderDialog.ShowDialog();
	...
	public void ExportWhitelistRules()
	{
		try
		{
			...
			DialogResult result = saveWhitelistFileDialog.ShowDialog();
			if (result != DialogResult.OK)
			{
				return;
			}
	...
	public void ChangeWhitelistRulesFilePath()
	{
		try
		{
			FolderBrowserDialog whitelistFolderDialog = new()
			{
				ShowNewFolderButton = true
			};
			...
			DialogResult result = whitelistFolderDialog.ShowDialog();
			if (result == DialogResult.OK)
			{
	...
	public void RemoveWhitelistRule()
	{
		try
		{
			if (string.IsNullOrEmpty(_selectedDomainWhitelistEntry))
			{
				return;
			}
	...
	public void RemoveBlacklistRule()
	{
		try
		{
			if (string.IsNullOrEmpty(_selectedDomainBlacklistEntry))
			{
				return;
			}
	...
	public void ExportBlacklistRules()
	{
		try
		{
			...
			DialogResult result = saveBlacklistFileDialog.ShowDialog();
			if (result != DialogResult.OK)
			{
				return;
			}
