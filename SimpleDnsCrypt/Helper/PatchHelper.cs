...
public static class PatchHelper
{
	public static bool Patch()
	{
		...
		if (version.Equals("0.7.2"))
		{
			...
			Nett.TomlSettings settings = Nett.TomlSettings.Create(s => s.ConfigurePropertyMapping(m => m.UseTargetPropertySelector(standardSelectors => standardSelectors.IgnoreCase)));
